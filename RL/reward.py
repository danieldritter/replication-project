...
def advantage(values, returns, n_step=15, gamma=1):
    """
    Args:
...
print(advantage(np.array([2,3,4,5,2,3,4,5,2,3,4,5,2,3,4,5,2,3,4,5,2,3,4,5,2,3,4,5]), np.array([2,3,4,5,2,3,4,5,2,3,4,5,2,3,4,5,2,3,4,5,2,3,4,5,2,3,4,5])))
